...
//BOLITAS
  //Bola uno MAS CHICA
  FCircle bolaBol = new FCircle (30);
  ...
  //Bola dos MEDIANA
  FCircle bolaBol1 = new FCircle (45);
  bolaBol1.setPosition(100, 100);
  bolaBol1.setRestitution(1.5);//VARIABLE
  ...
  //Bola tres GRANDE
  FCircle bolaBol2 = new FCircle (60);
