...
void draw() {
  ...
  if (monitor) {
    ...
    push();
    fill (0, 255, 0);
    ellipse (xpuntero, ypuntero, 50, 50);
    pop();
  }
...
void iniciarJuego() {
  ...
  nube2.setName("plataformaNube2");////////////////////////// NUBE 1 SETNAME
  mundo.add(nube2);
  ...
  nube3.setName("plataformaNube3");////////////////////////// NUBE 1 SETNAME
  mundo.add(nube3);
